package com.xin.exchange.quotation.common.errorcode;
 ...
 * @author: 系统
 */
public enum ExchangeQuotationErrorCode implements ErrorCode {
    ...
    ExchangeQuotationErrorCode(final int code) {
        this.code = code;
    }
