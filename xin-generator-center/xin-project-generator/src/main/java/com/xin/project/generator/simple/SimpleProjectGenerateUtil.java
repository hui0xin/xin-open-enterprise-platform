...
public class SimpleProjectGenerateUtil {
    ...
    public static void generateSimpleProject(String filePath, String projectName, String projectDesc, Boolean isMultiEnv, Boolean isDockerProject) throws Exception {
